...
public class ExtratoActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extrato2);
        ...
        extrato_array = new ArrayList<>();




        voltar = (ImageView) findViewById(R.id.voltar_button_ext2);
        ...
        filtro_tv = (TextView) findViewById(R.id.filtro_dropdown_ext);
        ...
        mes_tv = (TextView) findViewById(R.id.mes_dropdown_ext);
        ...
        ano_tv = (TextView) findViewById(R.id.ano_dropdown_ext);
        ...
        buscar = (Button) findViewById(R.id.buscar_ext_button);
    ...
    public void buscarHistorico(){
        if(extrato_array.isEmpty())
            Toast.makeText(ExtratoActivity2.this,"Nenhuma atividade encontrada para esse período!",Toast.LENGTH_SHORT).show();
        else{
            Collections.sort(extrato_array);

            Intent intent = new Intent(ExtratoActivity2.this,ExtratoActivity.class);
            intent.putExtra("mes",mes);
            intent.putExtra("ano",ano_id);
            intent.putExtra("filtro",filtro);
            Bundle bundle = new Bundle();
            bundle.putSerializable("array", extrato_array);
    ...
    public void showFiltroDialog(){
        AlertDialog.Builder dialog = new AlertDialog.Builder(ExtratoActivity2.this);
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    ...
                    Toast.makeText(ExtratoActivity2.this,"Nenhum caminhão cadastrado!",Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void armazenarArrayAno(){
        db = db.getRoot();
        String user = UserFirebase.getCurrentUserEmail();
        db = db.child("Usuarios").child(user).child("extrato");
        db.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    ...
                    Toast.makeText(ExtratoActivity2.this,"Nenhuma entrega cadastrada!",Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void armazenarArrayExtrato(){
        extrato_array.clear();
        if(filtro.equals("Geral")) {
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for(DataSnapshot ds: dataSnapshot.getChildren()) {
                        LinhaExtrato linha = ds.getValue(LinhaExtrato.class);
                        if(linha.getAno() == ano_id)
                            extrato_array.add(linha);
                    }
                }
